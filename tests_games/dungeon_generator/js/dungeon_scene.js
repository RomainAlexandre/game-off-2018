import tilesAssets from '../../../assets/dungeon_generator/tilesets/buch-tileset-48px-extruded.png';
import characterAssets from '../../../assets/dungeon_generator/spritesheets/buch-characters-64px-extruded.png';

import Phaser from "phaser";
import Dungeon from "@mikewesthad/dungeon";
import Player from "./player.js";
import TILES from "./tile_mapping.js";
import TilemapVisibility from "./tilemap_visibility.js";
...
export default class DungeonScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image("tiles", tilesAssets);
